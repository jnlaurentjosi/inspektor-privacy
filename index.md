...
The one thing that leaves your device is the photos you choose to submit for inspection. And your inspection photos are not kept, either: once the analysis is done, the app deletes them. The only photo that stays on your phone is the optional My Standard photo of your room at its best, which you can view and remove in Settings at any time (see section 3). Otherwise only your scores, verdicts, streaks, and settings remain. The photos you submit are sent, over an encrypted connection, through a small relay server we operate and on to Anthropic (the company behind the Claude AI model) so the analysis can be produced. Our relay does not store your photos or your results; it keeps only short-lived technical logs (see section 3). Anthropic processes your photos to return the analysis and automatically deletes API inputs and outputs from its systems within 30 days; it does not use them to train its AI models.
...
|---|---|---|---|
| Room photos (typically 2 per inspection, plus an optional My Standard photo of your room at its best) | Sent over HTTPS through our relay server to Anthropic's Claude API to generate your inspection score and verdict. Inspection photos are deleted from your device automatically once the analysis is complete. The My Standard photo is converted once into a short text description of your room's standard. Both the description and the photo then stay on your device; the photo may be sent again alongside a later inspection as the reference your room is compared against. You can view, replace, or remove it in Settings at any time. | To provide the core AI inspection feature. | Yes, transiently, for analysis only (see section 3). |
...
Anthropic processes the photos solely to return the analysis to you. Under Anthropic's commercial API terms, API inputs and outputs are not used to train Anthropic's AI models, and Anthropic automatically deletes API inputs and outputs from its systems within 30 days of processing. Anthropic may retain data for longer only in the exceptional case where content is flagged by its safety systems as violating its usage policy. You can read Anthropic's commercial terms and privacy documentation at anthropic.com and privacy.claude.com.

After the analysis, the app deletes your inspection photos from your device once your score and verdict have been produced. The one exception is your optional My Standard photo. It stays on your device so you can see the standard you set, and so the app can send it alongside a later inspection as the reference. It is held in the app's cache storage, which iOS does not include in iCloud backups, and you can replace or remove it in Settings at any time; removing it deletes the photo and the standard together. While any photo sits on your device awaiting analysis, it is held in that same cache storage. What remains on your device afterwards is your inspection history: scores, verdicts, deltas, and dates. We operate no database of user content and have no way to view, retrieve, or restore anything of yours.

Please photograph your room, not your life. Photos of a room can incidentally capture things that reveal more than tidiness: documents on a desk, medication on a nightstand, religious or political items, medical equipment, photos of other people. We ask you to frame your room only and to keep such items (and other people) out of frame. The AI model is instructed to assess tidiness and order only. If something sensitive is captured incidentally despite this, it is processed transiently as described above, is never stored on any server we operate, is deleted from Anthropic's systems within 30 days, and is deleted from your own device once the analysis completes (or, for a My Standard photo, stays on your device only until you remove it in Settings). We do not seek, extract, or use any such information.
...
- **On your device:** inspection photos are deleted automatically once the analysis is complete. The optional My Standard photo stays on your device until you replace or remove it in Settings, or delete the app. Your inspection history (scores, verdicts, deltas, dates) and all habit data remain until you delete them in the app or delete the app itself. Deleting the app deletes everything.
